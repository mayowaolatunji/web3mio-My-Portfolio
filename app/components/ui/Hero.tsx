...
export const Hero: FC<HeroProps> = () => {
  ...
  return (
    <div className="mx-auto custom-container w-full h-full lg:h-[900px] relative flex flex-col lg:flex-row lg:flex justify-center items-start lg:items-center p-3 lg:p-0" id="hero">
        <div className="w-full lg:w-1/2 relative">
          <div className="w-[220px] lg:w-[300px] h-1 bg-[#10c8ff] mb-7 lg:mb-16"></div>
          <Typography
            className="text-[#F7F7FC] text-[16px] lg:text-[22px]"  {...commonProps}>
            Hi There!
          </Typography>
          <Typography
            className="text-[#10c8ff] text-[24px] lg:text-[47px]"  {...commonProps}>
            Welcome to my Portfolio
          </Typography>
          <Typography
            className="text-[#F7F7FC] text-[22px] lg:text-[37px]"  {...commonProps}>
            I am Mayowa Olatunji, a web3 Technical Writer.
          </Typography>
          <Typography
              className="text-[#F7F7FCB3] font-normal text-[18px] lg:text-[28px] w-full"  {...commonProps}>
          ...
          <Space size={15} className="mt-4">
            ...
            <Button {...commonProps} className="border-2 border-[#10c8ff] text-[#10c8ff] bg-transparent hover:bg-[#10c8ff] hover:text-white" size="lg">
              Download CV
            </Button>
          </Space>
          ...
          <div className="flex items-start w-full mt-10 gap-5">
            <Typography
              className="text-[#10c8ff] text-[14px] uppercase"  {...commonProps}>
              follow me on 
            </Typography>
        ...
        <div className="w-full lg:w-1/2 h-full relative">
          <div className="absolute z-[-10] bottom-[-340px] left-0 hidden lg:block">
            <svg width="462" height="977" viewBox="0 0 462 977" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M289.065 484.49L0.792554 69.9892L209.058 0.902126L461.055 393.617L289.065 484.49Z" stroke="#10c8ff"/>
            </svg>
          </div>
          <div className="absolute z-[-10] top-[70px] right-0 hidden lg:block">
            <svg width="379" height="480" viewBox="0 0 379 480" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0.770121 459.146L213.26 1.15021L377.968 146.129L165.991 561.812L0.770121 459.146Z" stroke="#10c8ff"/>
            </svg>
          </div>
          {showAltImage ? (

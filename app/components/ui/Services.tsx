...
export const Services: FC<ServicesProps> = () => {
  ...
  return (
    <div className="mx-auto custom-container w-full h-full lg:h-[900px] flex flex-col justify-center gap-10 items-center p-3 lg:py-10" id="services">
      <Typography
        className="text-[#10c8ff] text-[22px] lg:text-[32px]  mt-10"  {...commonProps}>
        MY SERVICES
      </Typography>
      <div className="flex flex-col lg:flex lg:flex-row items-center justify-center gap-10">
        <Card className="w-full lg:w-[400px] h-[500px] bg-[#1D1B1B] shadow-xl flex flex-col items-center justify-center" {...commonProps}>
          <CardBody {...commonProps} className="flex flex-col items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#10c8ff" className="w-16 h-16">
